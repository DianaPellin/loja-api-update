...
public class AnunciosController {
    ...
    @PostMapping
    @Transactional
    public void cadastrar(@RequestBody @Valid AnuncioForm anuncioForm, UriComponentsBuilder uriBuilder) {
    ...
    @PutMapping("/{id}")
    @Transactional
    public void atualizar(@PathVariable Long id, @RequestBody @Valid AnuncioForm form) {
